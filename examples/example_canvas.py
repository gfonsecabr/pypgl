...
def main():
    ...
    shapes = [
        ...
        pgl.MonotoneChain([0, 0, 2, 6, 4, 1, 6, 8, 8, 3]),
        pgl.Polyline([0, 0, 8, 8, 0, 8, 8, 0]),                # self-crossing
        pgl.Triangle(0, 0, 8, 0, 4, 8),
        pgl.Rectangle(0, 0, 8, 8),
        pgl.Disk(pgl.Point(4, 4), 4),
        pgl.Convex([0, 3, 0, 5, 3, 8, 5, 8, 8, 5, 8, 3, 5, 0, 3, 0]),
        pgl.Polygon([0, 0, 8, 0, 8, 8, 4, 4, 0, 8]),           # non-convex
        pgl.PolygonWithHoles(
            pgl.Polygon([0, 0, 8, 0, 7, 5, 8, 8, 0, 8]),
            [pgl.Polygon([2, 2, 4, 2, 6, 6])],
        ),
